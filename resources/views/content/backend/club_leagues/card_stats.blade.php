                            ...
                            @forelse ($data as $row)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <em>
                                            {{$row->yellow_cards_home_min}}
                                        </em>
                                    </td>
                                    <td class="text-center">
                                        <em>
                                            {{$row->yellow_cards_home_avg}}
                                        </em>
                                    </td>
                                    <td class="text-center">
                                        <em>
                                            {{$row->yellow_cards_home_max}}
                                        </em>
                                    </td>

                                    <td class="text-center">
                                        <em>
                                            {{$row->yellow_cards_away_min}}
                                        </em>
                                    </td>
                                    <td class="text-center">
                                        <em>
                                            {{$row->yellow_cards_away_avg}}
                                        </em>
                                    </td>
                                    <td class="text-center">
                                        <em>
                                            {{$row->yellow_cards_away_max}}
                                        </em>
                                    </td>

                                    <td class="text-center">
                                        <em>
                                            {{$row->red_cards_home_min}}
                                        </em>
                                    </td>
                                    <td class="text-center">
                                        <em>
                                            {{$row->red_cards_home_avg}}
                                        </em>
                                    </td>
                                    <td class="text-center">
                                        <em>
                                            {{$row->red_cards_home_max}}
                                        </em>
                                    </td>

                                    <td class="text-center">
                                        <em>
                                            {{$row->red_cards_away_min}}
                                        </em>
                                    </td>
                                    <td class="text-center">
                                        <em>
                                            {{$row->red_cards_away_avg}}
                                        </em>
                                    </td>
                                    <td class="text-center">
                                        <em>
                                            {{$row->red_cards_away_max}}
                                        </em>
                                    </td>
