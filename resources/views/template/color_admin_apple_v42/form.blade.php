...
<body>
		...
		<div id="content" class="content">
			...
			<div class="panel panel-inverse">
				<div class="panel-heading">
					...
					<h4 class="panel-title">Panel Form</h4>
				</div>
	...
	<!-- ================== BEGIN PAGE LEVEL JS ================== -->
	<script src="{{ asset('/color_admin_v42') }}/assets/plugins/highlight/highlight.common.js"></script>
	<script src="{{ asset('/color_admin_v42') }}/assets/js/demo/render.highlight.js"></script>
	<!-- ================== END PAGE LEVEL JS ================== -->
	<script>
