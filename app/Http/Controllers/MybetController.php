...
class MybetController extends Controller
{
    //
    ...
    {        
        $data           = DB::table('fixtures as f')
                            ...
                            ->select(
                                ...
                                'f.home_wdl_handicap_goals',
                                'f.away_wdl_handicap_goals',

                                'f.home_wdl_corners',
                                'f.away_wdl_corners',

                                'f.home_wdl_handicap_corners',
                                'f.away_wdl_handicap_corners',

                                'f.home_wdl_yellow_cards',
                                'f.away_wdl_yellow_cards',

                                'f.home_wdl_red_cards',
                                'f.away_wdl_red_cards',
    ...
    public function edit(Fixture $Mybet)
    {
        $content    = 'Mybet';
        $panel_name = 'Mybet';
        ...
        $home_data_1    = fixture::join('clubs as ch', 'ch.id', '=', 'fixtures.home_clubs_id')
                                        ...
                                        ->select(
                                            ...
                                            ->where('fixtures.home_clubs_id',$Mybet->home_clubs_id)
                                            ->where('fixtures.leagues_id',$Mybet->leagues_id);
        ...
        $htoh_1         = fixture::join('clubs as ch', 'ch.id', '=', 'fixtures.home_clubs_id')
                                        ...
                                        ->select(
                                            ...
                                            ->whereNotNull('fixtures.away_goals')
                                            ->where('fixtures.home_clubs_id',$Mybet->home_clubs_id)
                                            ->where('fixtures.away_clubs_id',$Mybet->away_clubs_id);
        ...
        $htoh_data      = fixture::join('clubs as ch', 'ch.id', '=', 'fixtures.home_clubs_id')
                                    ->join('clubs as ca', 'ca.id', '=', 'fixtures.away_clubs_id')        
                                        ...
                                        ->select(
                                            ...
                                            ->whereNotNull('fixtures.home_goals')
                                            ->whereNotNull('fixtures.away_goals')
                                            ->where('fixtures.home_clubs_id',$Mybet->away_clubs_id)
                                            ->where('fixtures.away_clubs_id',$Mybet->home_clubs_id)
                                            ->union($htoh_1)
        ...
        $home_ss        = Club_league::join('clubs', 'clubs.id', '=', 'club_leagues.clubs_id')
                                    ...
                                    ->where('club_leagues.clubs_id', $Mybet->home_clubs_id)
                                    ->get();   
        ...
        $away_ss        = Club_league::join('clubs', 'clubs.id', '=', 'club_leagues.clubs_id')
                                    ...
                                    ->where('club_leagues.clubs_id', $Mybet->away_clubs_id)
                                    ->get();
        ...
        $clubs          = Club::select(
                                    ...
                                    ->whereIn('clubs.id',[$Mybet->home_clubs_id,$Mybet->away_clubs_id,])
                                    ->orderBy('nama','Asc')
                                    ->get();
    ...
    public function update(Request $request, Fixture $Mybet)
    {
        $content    = 'Mybet';

        $Mybet = Fixture::findOrFail($Mybet->id);
